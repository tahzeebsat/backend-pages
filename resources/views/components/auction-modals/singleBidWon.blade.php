    <div class="modal fade cmn--modal" id="single_won" tabindex="-1" aria-labelledby="single_wonLabel"
        aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            <label class="fw-noraml text--black">Won Details</label>
                            <div class="grid-cmn-4">
                                <div class="cmn--card">
                                ...
                                <div class="cmn--card">
                                    ...
                                    <p class="fs-6 fw-bold text--green">$655</p>
                                    <p class="text--green fs-12 d-flex align-items-center gap-1"><span
                                            class="status--dots won"></span>Winning price</p>
                                </div>
                                <div class="cmn--card">
                                    <label class="text--grey fw-normal">SAT BALANCE</label>
                                    <p class="fs-6 fw-bold text--blue">$1,500</p>
                        ...
                        <div class="col-12">
                            ...
                            <div class="cmn--card">
                                <p class="text--grey">Repeat customer, priority bidding</p>
                            </div>
                        </div>
                        <div class="col-12">
                            <button class="sat-btn primary">Create Order</button>
                        </div>
                    </div>
                </div>
            </div>
