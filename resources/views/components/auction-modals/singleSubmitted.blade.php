    <div class="modal fade cmn--modal" id="single_Submitted" tabindex="-1" aria-labelledby="single_SubmittedLabel"
        aria-hidden="true">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <span class="sat-status submitted-status border--status">SUBMITTED</span>
                    </div>
                ...
                <div class="modal-body">
                    <div class="payment--approved-1">
                        <div class="row g-3">
                                ...
                                <div class="cmn--card">
                                    ...
                                    <div class="d-flex align-items-center gap-2 justify-content-between">
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <div class="fs-14 fw-noraml text--black">$28,017</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="d-flex align-items-center gap-2">
                                    <button class="sat-btn success" data-bs-target="#single_submittedDeposithandling"
                                        data-bs-toggle="modal" onclick="showSubmitWon()">
                                        Mark Won
                                    </button>

                                    <button class="sat-btn grey" data-bs-target="#single_submittedDeposithandling"
                                        data-bs-toggle="modal" onclick="showSubmitLost()">
                                        Mark Lost
                                    </button>
                                </div>
                            </div>
    ...
    <div class="modal fade cmn--modal" id="single_submittedDeposithandling" tabindex="-1" aria-hidden="true">
                ...
                <div class="modal-body">
                    <div class="payment--approved-2">
                        <div class="row g-3">
                            ...
                            <div class="col-12 mark-lost-submit d-none">
                            ...
                            <div class="col-md-12 mark-won-submit">
                            ...
                            <div class="col-12">
                                ...
                                <div class="balance--summary">
                                    ...
                                    <div
                                        class="d-flex align-items-center gap-2 justify-content-between p-3 pb-2 bg--white-secondary">
                            ...
                            <div class="col-12">
                                <div class="d-flex align-items-center gap-2">
                                    <button class="sat-btn light" data-bs-target="#single_Submitted"
