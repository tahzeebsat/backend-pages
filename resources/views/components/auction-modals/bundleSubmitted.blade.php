    <div class="modal fade cmn--modal" id="bundle_submitted" tabindex="-1"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            <button class="sat-btn primary" data-bs-target="#bundle_deposithandling_submitted"
    ...
    <div class="modal fade cmn--modal" id="bundle_deposithandling_submitted" tabindex="-1" aria-hidden="true">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-12">
                                <div class="bid--type-selection">
                                    <input type="radio" class="btn-check bid-type-toggle"
                                        name="bundleDeposit_paymenthandling" id="bundle_deposit_paymentapproved"
                                        data-type="single" checked />
                                    <label class="btn mb-0" for="bundle_deposit_paymentapproved">
                            ...
                            <div class="col-md-12">
                                <div class="bid--type-selection">
                                    <input type="radio" class="btn-check bid-type-toggle"
                                        name="bundleDeposit_paymenthandling" id="bundle_deposit_sat_balancepayment"
                                        data-type="bundle">
                                    <label class="btn mb-0" for="bundle_deposit_sat_balancepayment">
