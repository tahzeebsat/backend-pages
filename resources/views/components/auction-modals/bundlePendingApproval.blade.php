    <div class="modal fade cmn--modal" id="bundle_pendingapproval" tabindex="-1"
        aria-labelledby="bundle_pendingapprovalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <div class="d-flex align-items-center gap-2">
                        <h1 class="modal-title fs-5" id="new_bidLabel">BID-119 — Lagos Auto Mart</h1>
                            ...
                            <div class="cmn--card mb-2">
                                <div class="d-flex align-items-center gap-2 justify-content-between mb-2">
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <div class="fs-14 fw-noraml d-flex align-items-center gap-2"><span class="text--black">LOT-8832</span> <span class="text--grey">USS
