    ...
    <div class="modal fade cmn--modal sm--modal" id="upload_payment_proof" tabindex="-1" aria-labelledby="upload_payment_proofLabel" aria-hidden="true">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        <div class="swap--wrapper-img">
                            ...
                            <div class="payment--proof-upload">
                                <label class="fw-noraml text--black">Upload Proof</label>
                    ...
                    <div class="col-12">
                        <div class="d-flex align-items-center justify-content-end gap-2">
                            ...
                            <button class="sat-btn primary">Upload Proof</button>
                        </div>
                    </div>
                </div>
            </div>
