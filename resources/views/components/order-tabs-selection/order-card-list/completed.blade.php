<div class="card-detail border {{ $class ?? '' }}">
    ...
    <div class="collapse col_rec" id="collapse_receipt{{ $iteration }}">
        ...
        <div class="completed_order tab-content" style="display: block;">
            ...
            <div class="accordians-selection">
                <div class="accordion accordion-flush" id="accordion_completed_orders_mobile{{ $iteration }}">
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button position-relative collapsed" type="button">
                                ...
                                data-bs-target="#completed_order_one{{ $iteration }}_agust" aria-expanded="false"
                                aria-controls="completed_order_one{{ $iteration }}_agust">
                                Agust
                                <div class="d-flex">
                        ...
                        <div id="completed_order_one{{ $iteration }}_agust" class="accordion-collapse collapse"
                            data-bs-parent="#accordion_completed_orders_mobile{{ $iteration }}">
                                ...
                                <div class="item-selections-install gap-2">
                                    <div class="upload-field mb-0">
                                        <input type="text" disabled="" placeholder="Invoice"
                                            id="mobile_field{{ $iteration }}_agust">
                                        <button type="button"
                                            onclick="handleUpload('upload_receipt_field{{ $iteration }}_agust', 'mobile_field{{ $iteration }}_agust')">Upload</button>
                                        <input type="file" hidden=""
                                            id="upload_receipt_field{{ $iteration }}_agust">
                                    </div>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button position-relative collapsed" type="button">
                                <div class="d-flex justify-content-between flex-grow-1 edit-header"
                                data-bs-toggle="collapse"
                                data-bs-target="#completed_order_two{{ $iteration }}_december"
                                aria-expanded="false"
                                aria-controls="completed_order_two{{ $iteration }}_december">
                                December
                                <div class="d-flex">
                                    <img src="{{ asset('assets/images/icons/arrow-drop-down-line.svg') }}"
                                        class="downarrow" height="18" width="18" alt="chevron">
                        ...
                        <div id="completed_order_two{{ $iteration }}_december" class="accordion-collapse collapse"
                            data-bs-parent="#accordion_completed_orders_mobile{{ $iteration }}">
                            <div class="accordion-body">
                                <div class="item-selections-install mb-2">
                                    <h2 class="table-heading-card">Amount Due:</h2>
