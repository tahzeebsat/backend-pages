<div class="card-detail border {{ $class ?? '' }}">
    ...
    <div class="collapse col_rec" id="collapse_receipt{{ $iteration }}">
        ...
        <div class="accordians-selection">
            <div class="accordion accordion-flush" id="accordion_total_orders_mobile{{ $iteration }}">
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button position-relative collapsed" type="button">
                            <div class="d-flex justify-content-between flex-grow-1 edit-header"
                                data-bs-toggle="collapse" data-bs-target="#totla_order_one{{ $iteration }}_november"
                                aria-expanded="false" aria-controls="totla_order_one{{ $iteration }}_november">
                                November
                                <div class="d-flex">
                    ...
                    <div id="totla_order_one{{ $iteration }}_november" class="accordion-collapse collapse"
                        data-bs-parent="#accordion_total_orders_mobile{{ $iteration }}">
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button position-relative collapsed" type="button">
                            <div class="d-flex justify-content-between flex-grow-1 edit-header"
                                data-bs-toggle="collapse" data-bs-target="#totla_order_two{{ $iteration }}_december"
                                aria-expanded="false" aria-controls="totla_order_two{{ $iteration }}_december">
                                December
                                <div class="d-flex">
                                    <img src="{{ asset('assets/images/icons/arrow-drop-down-line.svg') }}"
                                        class="downarrow" height="18" width="18" alt="chevron">
                    ...
                    <div id="totla_order_two{{ $iteration }}_december" class="accordion-collapse collapse"
                        data-bs-parent="#accordion_total_orders_mobile{{ $iteration }}">
                        <div class="accordion-body">
                            <div class="item-selections-install mb-2">
                                <h2 class="table-heading-card">Amount Due:</h2>
