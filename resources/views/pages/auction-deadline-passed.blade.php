...
<body>
                            ...
                            <ul class="nav nav-tabs custom-tabs variant3" id="myTab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <a onclick="window.location.href='/auction/deadline-passed'"
                                        href="/auction/deadline-passed" class="nav-link active" id="deadline-tab"
                                        data-bs-toggle="tab">
                                        Deadline Passed
                                    </a>
                                </li>
                                                ...
                                                <div class="collapse sub-table-container" id="subTable1">
                                                    <div class="card mt-2 p-2">
                                                        <div
                                                            ...
                                                            <h6 class="mb-0"><b>All Bids - Toyota Camry 2020</b></h6>
                                                        ...
                                                        <table class="table sub-table">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="bid-time">$500</td>
                                                                    <td class="bid-time"><span
                                                                            class="chip chip--rejected">Rejected</span>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
    ...
    <script>
        ...
        // Loop through items and add active class based on current page
        menuItems.forEach(item => {
            if (item.dataset.page === 'dashboard') { // assuming current page is dashboard
