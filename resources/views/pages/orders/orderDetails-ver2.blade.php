        ...
        <div class="main-section w-100 vh-100">
            ...
            <div class="row g-3 pb-3">
                        ...
                        <div class="d-flex align-items-center gap-2 justify-content-between flex-wrap">
                            <div>
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        <span class="text--blue fs-4 fw-medium">ORD-ver2</span>
                                        <span class="sat-status pending-status">Pending</span>
                                        <span class="sat-status pending-status px-4">Awaiting Proof</span>
                                        <span class="sat-status manual-status gap-1"><img src="{{asset('/assets/images/icons/smartphone-line.svg')}}" height="18" width="18" alt="desktop"> SmartPhone</span>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center gap-2 mt-2">
                                    <span class="fs-6 text--black-light"> Created : Apr 24-2026-08:45:00</span>
                                    <span class="sat-status manual-status">Manual</span>
                                </div>
                            </div>
                            <div class="d-flex align-items-center gap-2">
                    ...
                    <div class="sat--sheet h-100 px-4">
                        ...
                        <div class="mt-2 pt-1">
                            ...
                            <div class="d-flex align-items-center gap-2 justify-content-between mb-2 pb-1">
                                ...
                                <span class="fs-16 fw-semibold text--green">$0</span>
                            </div>
                            <div class="d-flex align-items-center gap-2 justify-content-between mb-2 pb-1">
                                <span class="fs-16 fw-smibold text--black-light">Due</span>
                                <span class="fs-16 fw-semibold text--red">$72,000</span>
                            </div>
                            <div class="d-flex align-items-center justify-content-center mt-2 pt-1">
                                <button class="sat-btn primary w-100" style="max-width: 361px"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="height: 18px;width:18px;"><path d="M5 12h14"></path><path d="M12 5v14"></path></svg> Add Payment</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="sat--sheet h-100 px-4">
                        <div class="d-flex align-items-center gap-2 justify-content-between mb-2 pb-1">
                        <h5 class="fs-5 fw-semibold">Payment History</h5>
                        ...
                        <div class="d-flex flex-column gap-1 mt-2 pt-1 d-none">
                                <div class="fs-6 fw-normal text--black-light">Previous Orders <span class="text--blue">(2)</span> </div>
                                <div class="d-flex gap-1">
                                    <a href="/" class="fs-14 fw-normal text--blue">ORD-1001</a>
                                    <a href="/" class="fs-14 fw-normal text--blue">Ored-1002</a>
                            ...
                            <p class="text-center mb-3">No payments recorded yet</p>
                        </div>
                </div>
                                ...
                                <ul class="activity-log list-unstyled mb-0">
                                    ...
                                    <li class="activity-item">
                                        ...
                                        <div class="activity-content">
                                            ...
                                            <p class="activity-meta">Created : Apr 24-2026-08:45:00 . Admin</p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
